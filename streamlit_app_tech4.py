...
st.write('O modelo prevê queda nos preços no final de 2024, seguindo o comportamento de queda do segundo semestre e trazendo os menores valores observados no ano (abaixo dos 60 dólares, patamar observado pela última vez em 2021). A partir de janeiro de 2025, é previsto crescimento não linear, mas bem conservador')
...
st.write("2. MELHORAR AQUI Queda de 2014-2016: Impacto do aumento na produção de petróleo de xisto nos EUA.\\n")
